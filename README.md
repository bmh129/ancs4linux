...
**Known working:** Intel Bluetooth adapters (e.g. Intel BE200, as a built-in
M.2/PCIe card) pair via BLE correctly and iOS will display the
notification-permission prompt after pairing.
