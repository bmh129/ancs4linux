...
LE Create Connection
  ...
  Peer address: XX:XX:XX:XX:XX:XX   (iPhone identity address)
```
...
(`YY:YY:YY:YY:YY:YY`), stops scanning, then sends:

```
LE Create Connection
  Peer address type: Public (0x00)   ← should be Random (0x01)
  Peer address: YY:YY:YY:YY:YY:YY   (iPhone's current RPA)
...
`YY:YY:YY:YY:YY:YY` in advertisements, but the iPhone advertises as type Random.
...
@ MGMT Event: Connect Failed     LE Address: XX:XX:XX:XX:XX:XX  Status: Timeout

# BlueZ scans to find current RPA
< HCI Command: LE Set Scan Enable   Scanning: Enabled
> HCI Event: LE Advertising Report  Address type: Random  Address: YY:YY:YY:YY:YY:YY (Resolvable)
@ MGMT Event: Device Found          LE Address: XX:XX:XX:XX:XX:XX  ← controller resolved RPA!
...
< HCI Command: LE Create Connection
    ...
    Peer address: YY:YY:YY:YY:YY:YY
> HCI Event: Command Status   Status: Success  ← HCI accepted command
# (41s later: timeout because controller can't find a Public address YY:YY:YY:YY:YY:YY)
```
...
- **iPhone IS advertising**: RSSI -43 to -50 dBm visible; RPA `YY:YY:YY:YY:YY:YY`
...
| iPhone | XX:XX:XX:XX:XX:XX (public identity address) |
